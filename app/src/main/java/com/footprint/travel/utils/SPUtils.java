...
import com.footprint.travel.base.BaseApplication;
...
public class SPUtils {
     ...
     */
    private static final String SP_FILE_NAME = "MobilePay";
    private static SPUtils spUtils = null;
    private static SharedPreferences sharedPreferences;

    public static synchronized SPUtils getInstance() {
        sharedPreferences = BaseApplication.getAppContext().getSharedPreferences(SP_FILE_NAME, Context.MODE_PRIVATE);
        if (null == spUtils) {
            spUtils = new SPUtils();
        }
        return spUtils;
     ...
     * 设置是否首次进入App
     *
     * @param isFristRun true:首次进入 false 非首次进入
     */
    public void setAppFirstRun(boolean isFristRun) {
        try {
            sharedPreferences.edit().putBoolean("first_run", isFristRun).commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
