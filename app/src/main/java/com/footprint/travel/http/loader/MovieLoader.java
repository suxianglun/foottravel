...
import com.footprint.travel.entity.MovieSubject;
import com.footprint.travel.http.ObjectLoader;
import com.footprint.travel.http.RetrofitServiceManager;
...
public class MovieLoader extends ObjectLoader {
    ...
    public MovieLoader(){
        mMovieService = RetrofitServiceManager.getInstance().createService(MovieService.class);
    }
    ...
    public Observable<List<Movie>> getMovie(int start, int count){
        return observe(mMovieService.getTop250(start,count))
            ...
            public List<Movie> call(MovieSubject movieSubject) {
                Log.e("allen","movieSubject==="+movieSubject);
