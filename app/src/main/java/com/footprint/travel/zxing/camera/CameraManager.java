...
//	private static final int MAX_FRAME_HEIGHT = 675; // = 5/8 * 1080
    ...
    public synchronized void openDriver(SurfaceHolder holder)
        ...
        try {
            ...
            LogUtils.d(TAG, "Resetting to saved camera params: "
                    + parametersFlattened);
            // Reset:
...
//            int width = screenResolution.x * 1 / 8;
//            int height = screenResolution.y * 2 / 4;
//            int topOffset = (screenResolution.y - height) / 3;
//            framingRect = new Rect(width, topOffset,
//                    screenResolution.x - width + 40, topOffset + screenResolution.x
//                    - width * 2 + 40);
            int width = screenResolution.x * 1/ 5;
            int height = screenResolution.y * 2 / 4;
            int topOffset = (screenResolution.y - height) / 3+40;
            framingRect = new Rect(width-40, topOffset+200,
                    screenResolution.x - width + 40, topOffset + screenResolution.x
                    - width * 2 + 240);
